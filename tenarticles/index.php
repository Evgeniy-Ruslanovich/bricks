...
if ($route == 'main') {
    ...
    echo "<a href='index.php'>Вернуться к списку</a><br>";
    drawArticle($articles, $route);
}

function drawIndex($articles) {
    for($i=0; $i<=9; $i++) {
        $href = "index.php?route=$i";
        echo "<p><a href='" . $href . "'>" . $articles[$i]['name'] . "</a></p>";
    }
}

function drawArticle($articles, $route) {
